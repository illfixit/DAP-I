public class Testumgebung {
    ...
    public static void testDoublyLinkedList() {
        ...
        System.out.println();
        System.out.print("toArray(): ");
        arr = new Integer[integers.size() - 1];
        integers.toArray(arr);
        for (Integer i : arr) {
            System.out.print(i + " ");
        }
        ...
        DoublyLinkedList d = integers.flip();
        d.showAll();
        ...
        integers.add(17);
        integers.add(17);
        System.out.print("remove(new Integer(17)): ");
        integers.remove(new Integer(17));
        integers.showAll();
        ...
        integers2.add(21);
        integers2.add(24);
        System.out.print("concat(integers2): ");
        integers.concat(integers2);
        integers.showAll();
        System.out.print("Konstruktor: ");
        DoublyLinkedList integers3 = new DoublyLinkedList(integers);
        integers3.showAll();
        DoublyLinkedList integers4 = integers3.subList(2, 7);
        System.out.print("integer3.sublist(2,7) (ohne to-Index) - Ausgangsliste: ");
        integers3.showAll();
        System.out.print("integer3.sublist(2,7) (ohne to-Index) - Subliste: ");
        integers4.showAll();
        System.out.print("integers.removeAll(integers4): ");
        integers.removeAll(integers4);
        integers.showAll();
        System.out.print("integers.clear(): ");
        integers.clear();
        integers.showAll();
        ...
        integersAllEqual.add(5);
        System.out.println(
                "integersAllEqual.allEqual(): " + integersAllEqual.allEqual() + " (erwartetes Ergebnis: true)");
