public class Testumgebung
{
    ...
    public static void test()
    {
        ...
        System.out.println( singleNode.apply( 1 ) );
        System.out.println();
        ...
        System.out.print( "Test apply( 3 ) - zweiter Aufruf bigTree: " );
        System.out.println( bigTree.apply( 3 ) );
        System.out.println();
        
        System.out.print( "Test apply( 5 ) - bigTree: " );
        System.out.println( bigTree.apply( 5 ) );
        System.out.println();
